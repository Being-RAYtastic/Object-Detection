...
# Debugging Purposes
# if os.access(prototxt_path, os.R_OK):
...
# Loading the pre-trained model/Neural Network

net = cv2.dnn.readNetFromCaffe(prototxt_path, model_path)

# image = cv2.imread(image_path)
cap = cv2.VideoCapture(0)   # Video 
# Note: If you wanna do with image then remove the while loop 
while True:
    ret, image = cap.read()     # remove this if u are working with images
